...
namespace reflectpp
{
	namespace details
	{
		...
		{
			return associative_container_data<void, void, void>();
		}
		...
		REFLECTPP_INLINE auto get_associative_container_data(std::map<Key, T>) REFLECTPP_NOEXCEPT
		{
			...
			using value_type = typename std::map<Key, T>::mapped_type;

			associative_container_data<class_type, key_type, value_type> data;
		...
		REFLECTPP_INLINE auto get_associative_container_data(std::set<Key>) REFLECTPP_NOEXCEPT
		{
			...
			associative_container_data<class_type, key_type> data;
